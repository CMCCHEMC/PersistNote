...
import com.dv.persistnote.framework.ui.common.materialcalendarview.format.TitleFormatter;
...
public class MaterialCalendarView extends ViewGroup {
    ...
    /**
     * Set a {@linkplain com.dv.persistnote.framework.ui.common.materialcalendarview.format.WeekDayFormatter}
     * with the provided week day labels
     *
     * @param weekDayLabels Labels to use for the days of the week
     * @see com.dv.persistnote.framework.ui.common.materialcalendarview.format.ArrayWeekDayFormatter
     * @see #setWeekDayFormatter(com.dv.persistnote.framework.ui.common.materialcalendarview.format.WeekDayFormatter)
     */
    ...
    /**
     * Set a {@linkplain com.dv.persistnote.framework.ui.common.materialcalendarview.format.TitleFormatter}
     * using the provided month labels
     *
     * @param monthLabels month labels to use
     * @see com.dv.persistnote.framework.ui.common.materialcalendarview.format.MonthArrayTitleFormatter
     * @see #setTitleFormatter(com.dv.persistnote.framework.ui.common.materialcalendarview.format.TitleFormatter)
     */
